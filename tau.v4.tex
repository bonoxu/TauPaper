...
\abstract
{
Seven tau lepton decay final states were examined at the future \Pem\Pep Linear Collider. Tau leptonic physics is improtant as the branching ratio provides a precision test of the Standard Model. The spin state of the tau can  be used to mearsure the CP of the Higgs using the Higgs decaying to a tau pair channel. The classicifaction efficiencies of hadronic tau decay is also a benchmark test for the detector performance. In this paper, the leptonic, hadronic 1-prong and hadronic 3-prong final sates of the tau lepton were classified for the centre of mass (\rootS) \Pem\Pep collision energies of 100, 200, 500 and 1000\,GeV and for the silicon-tungsten electromagnetic calorimeter (ECal) cell sizes from 3 to 20\,mm. The main challenge of the classcification is the reconstruction and the separation of nearby photons as individual entities. The correct asscoication of the tracks from the tracking system to the deposited energy shower in the calorimeter is also important for the leptonic final states identification. The overall hadronic decay selection efficiency is over 90\% for c.o.m. \rootS = 100\,GeV for the range of the ECal cell sizes, whilst the selection efficiency degrades significantly from 3\,mm to 20\,mm ECal cell size for \rootS = 500 and 1000\,GeV.
}
